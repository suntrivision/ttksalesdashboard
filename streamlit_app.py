...
DATA_PATH = ROOT_DIR / "output" / "combined_data.csv"


def _config(key: str, default: str | None = None) -> str | None:
    """Read from env (local) or Streamlit Cloud secrets."""
...
SUPABASE_KEY = _config("SUPABASE_ANON_KEY")
SUPABASE_BUCKET = _config("SUPABASE_STORAGE_BUCKET", "sales-data")
SUPABASE_DATA_FILE = _config("SUPABASE_DATA_FILE", "combined_data.csv.gz")
